            ...
            <div className="w-full h-screen relative overflow-y-auto">
                ...
                <div className="max-w-screen-lg mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 mt-4 md:mt-8">
                        ...
                        <button onClick={() => navigate('/user/home')} /* TODO: Implement proper route for managing children */ className="h-40 md:h-48 rounded-3xl p-4 md:p-6 relative overflow-hidden shadow-lg flex flex-col justify-between items-start text-left bg-white transition-transform hover:scale-[1.02] group">
