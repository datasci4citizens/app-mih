...
export default function HmiInformations() {
    ...
    return (
        <div className="flex flex-col min-h-screen max-h-screen items-center p-[30px] justify-between overflow-auto">
            ...
            <div className="w-[100%]">
                <Link to="/patient-home"><Button className="w-[100%] bg-[#0F172A] hover:bg-[#0F172A]/90 ">Home</Button></Link>
            </div>
        </div>
